...
public class ADATestCasesSprint4 extends TestBase {
	...
	//Sprint 4
		...
		//Descoped in redesign site @Test(priority=54,description="# 202 - Verify the Jelly falvors are displaying or not")
		...
		// Descoped in Redisgn site @Test(priority=56,description="# 205 - Verify the description is displayed as button or not")
		...
		//Desoped in redesign @Test(priority=59,description="# 217 - Verify the price attribute has aria label or not")
		 public void priceAria() throws IOException, Exception{
			ADAActions.priceAria();
		}
		//Descoped in redesign site @Test(priority=60,description="# 219 - Verify the Modal has container or not")
		 public void modalContainer() throws IOException, Exception{
			ADAActions.modalContainer();
		}
		//Descoped in redesign site @Test(priority=61,description="# 220 - Verify the modal will be closed on click of esc button")
		 public void modalEsc() throws IOException, Exception{
			ADAActions.modalEsc();
		}
		//uncomment @Test(priority=62,description="# 324 - Verify the JB wedding centre as Heading")
		 public void jbHeading() throws IOException, Exception{
			ADAActions.jbHeading();
		}
		//uncomment (priority=63,description="# 326 - Verify the Image has alt attribute or not")
...
//		//shipping info page moved to builder.io and it has no list format
...
// New Release
		@Test(priority=122,description="# 206 - PLP - It is difficult for screen reader users to identify when one section ends and the next begins..")
		 public void screenreader() throws IOException, Exception{
			ADAActions.validatescreenreader();
		}
		@Test(priority=123,description="# 376 -  Quantity Text box in cart page.")
		 public void quantitytextbox() throws IOException, Exception{
			ADAActions.validatequantitytextbox();
		}
